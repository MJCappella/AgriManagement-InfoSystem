...
const myChart = new Chart(ctx, {
    type: 'bar', // Default type, mixed chart type will override
    data: {
        labels: labels,
        datasets: [
            {
                type: 'line', // Bar chart for Product A
                label: 'Product A',
                data: productAData,
            ...
            {
                type: 'line', // Bar chart for Product B
                label: 'Product B',
                data: productBData,
            ...
            {
                type: 'line', // Line chart for Product C
                label: 'Product C',
                data: productCData,
