...
<head>
    ...
    <!-- <script src="<?php echo BASE_URL; ?>/assets/js/all.min.js" integrity="sha512-u3fPA7V8qQmhBPNT5quvaXVa1mnnLSXUep5PS1qo5NRzHwG19aHmNJnj1Q8hpA/nBWZtZD4r4AX6YOt5ynLN2g==" crossorigin="anonymous" referrerpolicy="no-referrer" defer></script> -->
...
<body class="d-flex flex-column h-100">
    <div>
        ...
        <!-- Hero Section -->
        <div class="container-fluid bg-dark text-white text-center d-flex align-items-center justify-content-center" style="background-image: url('http://localhost/amis-project-/uploads/images/crops/default.jpg'); background-size: cover; height: 70vh; background-position: center;">
            <div>
  ...
  ================================================== -->
        <div class="container marketing text-center mt-4">
            <div class="row">
                <div class="col-lg-4">
                    <img class="bd-placeholder-img rounded-circle" src="http://localhost/amis-project-/uploads/images/crops/default.jpg" width="140" height="140" role="img" />
                ...
                <div class="col-lg-4">
                    <img class="bd-placeholder-img rounded-circle" src="http://localhost/amis-project-/uploads/images/crops/default.jpg" width="140" height="140" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false">
                ...
                <div class="col-lg-4">
                    <img class="bd-placeholder-img rounded-circle" src="http://localhost/amis-project-/uploads/images/crops/default.jpg" width="140" height="140" />
                    <h2 class="fw-normal">Our Goal</h2>
                    <p>We uphold the highest standards of integrity, ensuring honesty and accountability in all our operations. Committed to continuous innovation, we leverage cutting-edge technologies to meet the evolving needs of the agricultural community. We believe in collaboration, building strong relationships with all stakeholders, and promoting sustainable practices that protect the environment. Our customer-centric approach ensures we prioritize our customers' needs, delivering exceptional value and support.</p>
                    <p><a class="btn btn-secondary" href="#">Read More &raquo;</a></p>
                </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img src="http://localhost/amis-project-/uploads/images/crops/default.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" role="img" aria-label="Placeholder: 500x500" />
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img src="http://localhost/amis-project-/uploads/images/crops/default.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto rounded-corners" width="500" height="500" role="img" aria-label="Placeholder: 500x500" />
                </div>
            </div>
        ...
        <div class="p-5 mb-4 bg-body-tertiary rounded-3 just" style="background-color: #f8f9fa; border: 1px solid #dee2e6;">
