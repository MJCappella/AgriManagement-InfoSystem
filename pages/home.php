...
if (basename($_SERVER['PHP_SELF']) == basename(__FILE__)) {
    ...
    //exit;
    header('Location: ' . BASE_URL . '/public/index.php?route=home');
}
$pageTitle = 'Home';
...
<style>
    ...
    .featurette:nth-child(even) {
        background: linear-gradient(90deg, rgba(29, 53, 87, 1) 0%, rgba(69, 123, 157, 1) 100%);
        color: #fff;
        padding: 40px;
        border-radius: 10px;
    }
    ...
    .featurette[data-aos="fade-right"] {
...
<div class="container">
    ...
    <div class="row featurette" data-aos="fade-right">
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1"><i class="fas fa-seedling text-success"></i> We help farmers</h2>
            <p class="lead">Track your yields, advertise your products, and sell directly to buyers. <strong>Join over 5,000 satisfied farmers!</strong></p>
            <p><a class="btn btn-primary" href="#">Learn More &raquo;</a></p>
        </div>
        <div class="col-md-5">
            <img src="http://localhost/amis-project-/assets/images/farmers.png" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto rounded-corners" width="500" height="500" role="img" aria-label="Placeholder: 500x500" />
        </div>
    </div>
    ...
    <div class="row featurette" data-aos="fade-left">
        ...
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
                <i class="fas fa-shopping-cart text-success"></i>&nbsp; We help buyers
            </h2>
    ...
    <div class="row featurette" data-aos="fade-right">
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
                <i class="fas fa-truck text-danger"></i>&nbsp; We help transporters
            </h2>
    ...
    <div class="row featurette" data-aos="fade-left">
        ...
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
                <i class="fas fa-chart-bar text-warning"></i>&nbsp; We help marketing agencies
            </h2>
    ...
    <div class="row featurette" data-aos="fade-right">
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
                <i class="fas fa-landmark text-primary"></i>&nbsp; We help the government
            </h2>
