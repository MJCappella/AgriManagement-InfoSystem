        ...
        <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 250px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="#" class="nav-link link-dark" onclick="loadDemand(this)">
                            Demand Trends
                        </a>
                    </li>
                    <li>
                        <a href="#" class="nav-link link-dark" onclick="loadCustomerEngagement(this)">
                            Customer Engagement
                        </a>
                    </li>
                    <li>
...
<?php include("../../assets/js/marketing.script.js.php") ?>
