                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL; ?>/public/index.php?route=services">Services</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL; ?>/public/index.php?route=about">About</a>
                            </li>
                        </ul>
                        <ul class="navbar-nav">
                            <li class="nav-item">
                            ...
                            <?php echo isset($logoutButton) ? '' : '<li class="nav-item"><a class="nav-link" href="../pages/register.php">Sign Up</a></li>' ?>
